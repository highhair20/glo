...
/*     exec('bash /home/jason/gloframework/vendor/ZendFramework-$ZEND_VERSION-minimal/bin/zf.bash create project $PROJECT_NAME'); */
/*     zf enable layout */
    
    
    #
    # YUI related build tool steps
    #run Tool_Yui to create the client side of the app
